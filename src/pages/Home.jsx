...
export const Home = () => {
    ...
    return (
        <main>
            <section className="absolute top-1/2 left-1/2 -translate-1/2 flex items-center justify-center flex-col">
                <div className="w-fit h-full ml-[5px] mr-2.5 my-0 mb-5">
                    <svg className="h-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 136 26">
                ...
                <h1 className="font-[mont] text-3xl text-(--text-color) text-center"><span className="markedtext">Sacré-Coeur</span></h1>
